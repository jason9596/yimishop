...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/yimishop/Thinkshop/Admin/View/Public/css/style.css">
    <script src="/yimishop/Thinkshop/Admin/View/Public/js/jquery.min.js"></script> 
</head>
<body>
    <div id="houtai">
