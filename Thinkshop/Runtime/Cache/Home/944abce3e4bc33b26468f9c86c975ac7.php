            ...
            <div class="col-md-3"></div>
				<div class="col-md-6" style="border:1px solid #ccc;height:600px;">
					<form action="" method="post" class="form-signin" style="position:relative;max-width:360px;padding:15px;margin:0 auto;">
						...
						<img onclick="this.src=this.src+'?'+Math.random()" src="<?php echo U('Index/verify');?>" style="cursor:pointer;" name="verify">
						...
						<label class="dl"><a href="/yimishop/Home/Index/login">登&nbsp;&nbsp;录</a></label>
					</form>
				</div>
			</div>
		</div>
